...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="figures/shared_pair", help="Output directory relative to this script")
    ...
    umap_output_path = os.path.join(output_dir, f"tsne_{args.shared_direction}_{suffix}.pdf")
    heatmap_output_path = os.path.join(output_dir, f"centroid_angular_distances_{args.shared_direction}_{suffix}.pdf")
