...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="figures/unique_component", help="Output directory relative to this script")
    ...
    umap_output_path = os.path.join(output_dir, f"tsne_{suffix}.pdf")
