...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="figures/raw_embedding", help="Output directory relative to this script")
    ...
    output_path = os.path.join(output_dir, f"tsne_{suffix}.pdf")
