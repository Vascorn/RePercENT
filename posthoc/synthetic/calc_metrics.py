...
from posthoc.synthetic.helper_metrics import linear_probe_disentanglement_metric, component_dci_from_linear_probe
import yaml
import argparse
import wandb
...
def main():
    ...
    data_path = os.path.join(script_dir, "../..", "data", "repercent_synthetic", "dataset22") # change accordingly

    for split_idx in range(args.k2):
        # load data-split
